...
// Source verified on Celoscan + Blockscout:
//   https://celoscan.io/address/0x65f07f7863621da424d7ae7e7e038bd3dddb5f57
//
...
export const ARENA_V2_ADDRESS = (
  process.env.NEXT_PUBLIC_ARENA_V2_ADDRESS ?? "0x65f07f7863621da424d7ae7e7e038bd3dddb5f57"
) as `0x${string}`;
