...
/** Small gear icon button that opens the sound settings modal */
  ...
  return (
    <>
      <button
        ...
        style={{ background: "rgba(86,164,203,0.08)", border: "1px solid rgba(86,164,203,0.2)", borderRadius: 8, padding: "7px 10px", color: "#56a4cb", fontSize: 16, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.15s" }}
      >
        ⚙️
      </button>
      {open && <SoundSettings onClose={() => setOpen(false)} />}
    </>
  );
}
