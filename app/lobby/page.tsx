...
import { resolveRound } from "../lib/combatEngine"; // not used
...
export default function BlackMarket() {
  ...
  // Filter only premium cards from CARDS
                ...
                <div key={c.id} style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "center" }}>
                   <div style={{
                       ...
                       <div style={{ position: "absolute", bottom: 12, left: 12, right: 12, textAlign: "center" }}>
                           ...
                           <div style={{ fontSize: 13, fontWeight: 900, color: "white", textTransform: "uppercase", mt: 2 }}>{c.name}</div>
                       </div>
